                                ...
                                <div id="nuevas" class="panel-collapse collapse">
                                    <div  class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <label for="resp-tarea">Cliente:</label>
                                                <input type="text" class="form-control" id="tokenfield_cliente" style="width:auto;" id="resp-tarea"/>
                                            </div>
                                        </div>
                                        <p>
                                        <div class="row ">
      ...
      <div class="col-md-13"><!-- ./Esta div pertenece a los proyectos activos -->
        <div class="box box-default">
          <div class="box-header with-border" data-widget="collapse" href="tareas_personales"><i class="fa fa-minus"></i>
            <h3 class="box-title">Tareas Personales Pendientes</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
                <div class="content-wraper">
